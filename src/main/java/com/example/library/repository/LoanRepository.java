...
@Query("SELECT l FROM Loan l WHERE l.book.id = :bookId AND l.user.id = :userId AND
l.status = 'ACTIVE'")
Optional<Loan> findActiveLoanByBookAndUser(@Param("bookId") Long bookId, @Param("userId")
Long userId);
}